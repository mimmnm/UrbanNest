    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-3 left-3 right-3 flex gap-2 opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-400">
          <button className="flex-1 py-3 bg-white/95 backdrop-blur-sm rounded-xl text-[#111111] text-xs font-display font-medium tracking-wide flex items-center justify-center gap-2 hover:bg-[#111111] hover:text-white transition-colors duration-300">
            <ShoppingBag size={14} />
            Add to Cart
          </button>
          <button className="w-11 bg-white/95 backdrop-blur-sm rounded-xl text-[#111111] flex items-center justify-center hover:bg-[#66a80f] hover:text-white transition-colors duration-300">
            <Heart size={14} />
          </button>
        </div>
      </Link>
