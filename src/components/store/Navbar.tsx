                  ...
                  <div className="pt-7 mt-6 border-t border-[#d4e8c2]/60 space-y-1">
                    {isLoggedIn ? (
                      <>
                        ...
                        <button onClick={() => { closeMobile(); signOut({ callbackUrl: "/" }); }} className="flex items-center gap-3 py-3 text-sm font-display text-red-500 hover:text-red-600 transition-colors w-full">
